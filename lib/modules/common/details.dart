import 'package:english_xii_notes/modules/common/module.dart';
...
class ModuleList {
  ...
  listImage(int index) {
    return details[index].cimage;
  }

  listName(int index) {
    return details[index].cname;
  }

  listWriter(int index) {
    return details[index].cwriter;
  }

  listDescription(int index) {
    return details[index].cdescription;
  }

  List details = [
    Module(
      "assets/chapter_logo/1.jpg",
      "Grandmother",
      "Ray Young Bear",
