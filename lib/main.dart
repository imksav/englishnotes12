                    ...
                    Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          subtitle:
                              Text("Ray Young Bear", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          subtitle:
                              Text("Anton Chekhov", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          subtitle:
                              Text("W.B. Yeats", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          title: Text(
                              ...
                              style: titleTextStyle),
                          subtitle:
                              Text("Moti Nissani", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          title: Text("Full Fathom Five Thy Father Lies",
                              style: titleTextStyle),
                          subtitle:
                              Text("W. Shakespeare", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          title: Text("Traveling Through the Dark",
                              style: titleTextStyle),
                          subtitle: Text("William Stafford",
                              style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                    ...
                    Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          subtitle:
                              Text("Dylan Thomas", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          title: Text("The Last Voyage of the Ghost Ship",
                              style: titleTextStyle),
                          subtitle:
                              Text("Garica Marquez", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                    ...
                    Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          subtitle: Text("Gerard Manley Hopkins",
                              style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                    ...
                    Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          title:
                              Text("Women’s Business", style: titleTextStyle),
                          subtitle:
                              Text("Ilene Kantrov", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          title: Text("The Children Who Wait",
                              style: titleTextStyle),
                          subtitle:
                              Text("Marsha Traugot", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          subtitle: Text("Women and Children",
                              style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                    ...
                    Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          title: Text("The Tell-Tale Heart",
                              style: titleTextStyle),
                          subtitle: Text("IEdger Allan Poe",
                              style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                    ...
                    Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          title:
                              Text("Hansel and Gretel", style: titleTextStyle),
                          subtitle: Text("Jacob and Wilhelm",
                              style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                        ...
                        ListTile(
                          ...
                          subtitle: Text("Garrison Keillor",
                              style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                        ...
                        ListTile(
                          ...
                          title:
                              Text("The Boarding House", style: titleTextStyle),
                          subtitle:
                              Text("Wilhelm Grimn", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          title: Text("The Gingerbread House",
                              style: titleTextStyle),
                          subtitle:
                              Text("Robert Coover", style: subtitleTextStyle),
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
